...
@ApplicationScoped
public class NoticePublisher extends EventPublisher<Notification> {
    ...
    private static final Logger logger = Logger.getLogger(NoticePublisher.class.getName());
...
//        kafkaProperties.put("transactional.id", UUID.randomUUID().toString());
    ...
    public String getTopic() {
        String topic = kafkaProperties.getProperty("payslip.response.topic");
        return topic;
    }
